...
export const LivestockForm: React.FC = () => {
  ...
  // Use form data interface for state
  const [formData, setFormData] = useState<LivestockFormData>({
    tagId: '',
    type: 'CATTLE',
    breed: '',
    gender: 'male' as LivestockGender,
    dateOfBirth: '',
  ...
  const prepareSubmitData = (): CreateLivestockRequest => {
    ...
    // Type assertion to handle the missing created_at/updated_at properties
    return submitData as CreateLivestockRequest;
  };
